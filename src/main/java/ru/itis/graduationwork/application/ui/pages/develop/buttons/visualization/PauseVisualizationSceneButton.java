...
public class PauseVisualizationSceneButton extends Button {
    ...
    private void setIcon(){
        button.setIcon(IconsManager.getImageIcon(Image.PAUSE,
                IdeFramesIconsConstants.VISUALIZATION_ICON_BUTTON_WIDTH,
                IdeFramesIconsConstants.VISUALIZATION_ICON_BUTTON_HEIGHT));
    }

    private void setToolTipText(){
        button.setToolTipText(LocalizationManager.getLocaleTextByKey("ide.content.visualization-scene.control-buttons.pause.tooltip-text"));
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        System.out.println("Pause the scene!");
    }
