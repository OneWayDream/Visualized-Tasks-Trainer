...
public class OpenGuideButton extends Button {

    public OpenGuideButton(){
        super();
        createButton();
    }
    ...
    private void setIcon(){
        button.setIcon(IconsManager.getImageIcon(Image.GUIDE,
                MainFrameIconsConstants.RIGHT_PANEL_BUTTON_ICON_WIDTH,
                MainFrameIconsConstants.RIGHT_PANEL_BUTTON_ICON_HEIGHT));
    }

    private void setTextStyle(){
        button.setText(LocalizationManager.getLocaleTextByKey("main-frame.right-panel.buttons.open-guide.text"));
